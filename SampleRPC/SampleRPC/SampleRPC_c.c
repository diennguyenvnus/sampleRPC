...
handle_t SampleRPCBinding;


static const RPC_CLIENT_INTERFACE SamepleRPCInterface___RpcClientInterface =
    {
...
RPC_IF_HANDLE SamepleRPCInterface_v1_0_c_ifspec = (RPC_IF_HANDLE)& SamepleRPCInterface___RpcClientInterface;

extern const MIDL_STUB_DESC SamepleRPCInterface_StubDesc;

static RPC_BINDING_HANDLE SamepleRPCInterface__MIDL_AutoBindHandle;
    ...
    /* [in] */ unsigned long *ulData)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SamepleRPCInterface_StubDesc,
    ...
    /* [out] */ unsigned long *ulData)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SamepleRPCInterface_StubDesc,
                  (PFORMAT_STRING) &SampleRPC__MIDL_ProcFormatString.Format[30],
                  ( unsigned char * )&ulData);
    ...
    /* [in] */ USER userData)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&SamepleRPCInterface_StubDesc,
                      (PFORMAT_STRING) &SampleRPC__MIDL_ProcFormatString.Format[60],
                      ( unsigned char * )&SendDataAsynchronouslyToPipe_AsyncHandle);
    ...
    /* [string][in] */ const unsigned char *szOutput)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SamepleRPCInterface_StubDesc,
                  (PFORMAT_STRING) &SampleRPC__MIDL_ProcFormatString.Format[90],
...
static const MIDL_STUB_DESC SamepleRPCInterface_StubDesc = 
    {
    (void *)& SamepleRPCInterface___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &SampleRPCBinding,
    0,
